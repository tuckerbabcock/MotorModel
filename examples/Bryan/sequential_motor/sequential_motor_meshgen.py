...
csm_file = "model/sequential_motor.csm"
...
if surf_mesh_aim == "egadsTessAIM":
    surface_mesh.input.Mesh_Sizing = {
        ...
        "tooth": {"tessParams": [0.001, 0.0, 0.0]},
        "winding": {"tessParams": [0.001, 0.0, 0.0]},
        "magnets": {"tessParams": [0.001, 0.0, 0.0]},
        "rotor": {"tessParams": [0.001, 0.0, 0.0]},
    }
